...
export default function NearbyPrayers() {
  ...
  if (!locationGranted && !loading) {
    return (
      <div className="rounded-2xl bg-white dark:bg-stone-900 shadow-sm ring-1 ring-stone-100 dark:ring-stone-800 p-6">
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <h3 className="font-serif text-lg text-stone-900 dark:text-stone-100">Doa Di Sekitarmu</h3>
          ...
          <motion.button
            ...
            className="flex items-center gap-2 rounded-xl bg-stone-900 dark:bg-stone-100 px-5 py-2.5 text-sm font-semibold text-white dark:text-stone-900 hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors"
          >
    ...
    return (
      <div className="rounded-2xl bg-white dark:bg-stone-900 shadow-sm ring-1 ring-stone-100 dark:ring-stone-800 p-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400">Mencari doa di sekitarmu...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-3">
      ...
      {prayers.length === 0 ? (
        <div className="rounded-2xl bg-white dark:bg-stone-900 shadow-sm ring-1 ring-stone-100 dark:ring-stone-800 p-6 text-center">
        ...
        prayers.map((prayer, index) => (
          <motion.div
            ...
            className="rounded-2xl bg-white dark:bg-stone-900 shadow-sm ring-1 ring-stone-100 dark:ring-stone-800 p-4 hover:shadow-md transition-shadow"
          >
